...
public class CustMenu {
    public static void landing() {
        System.out.println("Welcome to CovidTracker Customer \n");
        ...
        switch (choice) {
            case 1 : cust = login(); break;
            case 2 : cust = signUp(); break;
            case 3 : return;
        }
        main(cust);
    }
    ...
    public static void checkIn(Customer c) {
        ...
        System.out.print("You successfully check in at " + Shop.shops.get(choice-1).getName());
        System.out.println(". The time is " + Visit.visits.get(Visit.visits.size() - 1).getDt());
